...
bool operator==(const ::graspit_interface::PlanGraspsActionGoal_<ContainerAllocator1> & lhs, const ::graspit_interface::PlanGraspsActionGoal_<ContainerAllocator2> & rhs)
{
