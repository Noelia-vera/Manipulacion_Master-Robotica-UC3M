...
bool operator==(const ::graspit_interface::SimAnnParams_<ContainerAllocator1> & lhs, const ::graspit_interface::SimAnnParams_<ContainerAllocator2> & rhs)
{
  return lhs.set_custom_params == rhs.set_custom_params &&
    lhs.YC == rhs.YC &&
    lhs.HC == rhs.HC &&
    lhs.YDIMS == rhs.YDIMS &&
    lhs.HDIMS == rhs.HDIMS &&
    lhs.NBR_ADJ == rhs.NBR_ADJ &&
    lhs.ERR_ADJ == rhs.ERR_ADJ &&
    lhs.DEF_T0 == rhs.DEF_T0 &&
    lhs.DEF_K0 == rhs.DEF_K0;
}
