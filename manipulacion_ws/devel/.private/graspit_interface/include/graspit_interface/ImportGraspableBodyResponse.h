...
bool operator==(const ::graspit_interface::ImportGraspableBodyResponse_<ContainerAllocator1> & lhs, const ::graspit_interface::ImportGraspableBodyResponse_<ContainerAllocator2> & rhs)
{
