...
bool operator==(const ::graspit_interface::MoveDOFToContactsResponse_<ContainerAllocator1> & lhs, const ::graspit_interface::MoveDOFToContactsResponse_<ContainerAllocator2> & rhs)
{
