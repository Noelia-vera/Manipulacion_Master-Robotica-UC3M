...
#if defined(_WIN32) && defined(SPACE_AXIS_ANGLE)
  #undef SPACE_AXIS_ANGLE
#endif
#if defined(_WIN32) && defined(SPACE_COMPLETE)
  #undef SPACE_COMPLETE
#endif
#if defined(_WIN32) && defined(SPACE_ELLIPSOID)
  #undef SPACE_ELLIPSOID
#endif
#if defined(_WIN32) && defined(SPACE_APPROACH)
  #undef SPACE_APPROACH
#endif
...
bool operator==(const ::graspit_interface::SearchSpace_<ContainerAllocator1> & lhs, const ::graspit_interface::SearchSpace_<ContainerAllocator2> & rhs)
{
