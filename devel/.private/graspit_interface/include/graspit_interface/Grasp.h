...
bool operator==(const ::graspit_interface::Grasp_<ContainerAllocator1> & lhs, const ::graspit_interface::Grasp_<ContainerAllocator2> & rhs)
{
  return lhs.graspable_body_id == rhs.graspable_body_id &&
    lhs.pose == rhs.pose &&
    lhs.dofs == rhs.dofs &&
    lhs.epsilon_quality == rhs.epsilon_quality &&
    lhs.volume_quality == rhs.volume_quality &&
    lhs.approach_direction == rhs.approach_direction;
}
