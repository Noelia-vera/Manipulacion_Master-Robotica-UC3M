...
bool operator==(const ::graspit_interface::PlanGraspsActionFeedback_<ContainerAllocator1> & lhs, const ::graspit_interface::PlanGraspsActionFeedback_<ContainerAllocator2> & rhs)
{
