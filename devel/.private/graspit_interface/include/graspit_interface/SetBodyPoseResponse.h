...
bool operator==(const ::graspit_interface::SetBodyPoseResponse_<ContainerAllocator1> & lhs, const ::graspit_interface::SetBodyPoseResponse_<ContainerAllocator2> & rhs)
{
