...
bool operator==(const ::graspit_interface::ApproachToContactRequest_<ContainerAllocator1> & lhs, const ::graspit_interface::ApproachToContactRequest_<ContainerAllocator2> & rhs)
{
  return lhs.moveDist == rhs.moveDist &&
    lhs.oneStep == rhs.oneStep &&
    lhs.id == rhs.id;
}
